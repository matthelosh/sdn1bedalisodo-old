<div class="ml-sm-auto pt-3 px-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            <div class="btn-group mr-2">
                ...
                <button class="btn btn-sm btn-outline-secondary" data-toggle="modal" data-target="#modalImportEkskul">
    ...
    <div class="formCreateGuru" style="display: none;">
        <div class="card">
            <div class="card-body">
                <h5>Tambah Ekskul</h5>
                <form action="/adm-ekskul/create" class="form form-inline formCreateGuru" method="POST">
                    {{ csrf_field() }}
                    <div class="row">

                            <div class="form-group col-sm-4">
                                <label for="kode_ekskul" class="col-sm-4">Kode Ekskul</label>
                                <div class="col-sm-8">
                                    <input type="text" name="kode_ekskul" id="kode_ekskul" placeholder="Kode Ekskul" class="form-control">
                                </div>
                            </div>
                            <div class="form-group col-sm-4">
                                <label for="nama_ekskul" class="col-sm-4">Nama Ekskul</label>
                                <div class="col-sm-8">
    ...
    <div class="table-responsive">
        <h4 class="text-center">DATA EKSKUL</h4>
...
<div class="modal fade" id="modalImportEkskul"  tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <form action="/adm-ekskul/import" method="POST" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Import Data Ekskul</h5>
                </div>
